...
export const Navbar = () => {
    ...
    <nav className={cn(
        ...
        isScrolled ? "py-3 bg-bakcground/80 backdrop-blur-md shadow-xs" : "py-5"
        )}
    >
        ...
        <div className="container flex items-center justify-between">
            <a href="#hero" className="text-xl font-bold text-primary flex item-center">
                <span className="relative z-10">
                    <span className="text-glow text-foreground"> Pratyush's </span>
                                     Portfolio 
            ...
            <div className={cn("fixed inset-0 bg-background/95 backdrop-blur-md z-40 flex flex-col items-center justify-center",
                "transtition-all duration-300 md:hidden",
